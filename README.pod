...
This is the I<README> for the L<File::Fingerprint> Perl module. You're probably 
...
CPAN web interfaces, such as L<CPAN Search|http://search.cpan.org/dist/File-Fingerprint> or 
L<MetaCPAN|http://www.metacpan.org/module/File::Fingerprint>:

=over 4

=item *	L<http://search.cpan.org/dist/File-Fingerprint>

=item *	L<http://www.metacpan.org/module/File::Fingerprint>
